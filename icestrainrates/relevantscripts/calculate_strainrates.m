function [elon, etrans, eshear, eEff, ez] = calculate_strainrates(vx, vy, thick, pixel_size, tol, ydir, ...
                                                                    thick_grid, length_scale, maxR, vxNoData, vyNoData,thickNoData)

% notes; if using thickness, uncomment line 190
%{ 
Original code from manuscript "Continent-wide estimates of Antarctic strain 
